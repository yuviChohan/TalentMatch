// src/app/pages/AdminProfile.tsx
      ...
      <div className="w-full max-w-6xl bg-white shadow-xl rounded-xl p-10">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col items-center">
            ...
            <input type="text" placeholder="LinkedIn Profile URL" className="border border-gray-300 rounded p-2 mt-4 w-full" />
          ...
          <div>
            <div className="mb-4">
              ...
              <input type="email" placeholder="admin@gmail.com" className="border border-gray-300 rounded p-2 w-full" />
            </div>
            <div className="mb-4">
              <label className="block text-gray-700">Edit Mobile Number:</label>
              <input type="text" placeholder="(000)-000-0000" className="border border-gray-300 rounded p-2 w-full" />
            </div>
            <div className="mb-4">
              <label className="block text-gray-700">Edit Address:</label>
              <input type="text" placeholder="XYZ - Admin Road, AB Canada" className="border border-gray-300 rounded p-2 w-full" />
            </div>
