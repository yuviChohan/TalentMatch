...
import '../public/css/webflow.css'; // Adjust the path based on your setup

export default function Home() {
  return (
    <>
      <Head>
        <title>My Webflow Next.js Project</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <main>
        {/* Paste the body content from your Webflow HTML export here 
...
const IndexPage = () => {
  return (
    <div dangerouslySetInnerHTML={{ __html: `
      <!DOCTYPE html>
      <!--  Last Published: Tue May 28 2024 15:28:59 GMT+0000 (Coordinated Universal Time)  -->
      <html data-wf-page="6650f385db1f6f7c9f5dd967" data-wf-site="6650f384db1f6f7c9f5dd916">
      <head>
        <meta charset="utf-8">
        <title>Hireup - Webflow HTML Website Template</title>
        ...
        <!DOCTYPE html><!--  Last Published: Tue May 28 2024 15:28:59 GMT+0000 (Coordinated Universal Time)  -->
<html data-wf-page="6650f385db1f6f7c9f5dd967" data-wf-site="6650f384db1f6f7c9f5dd916">
<head>
  <meta charset="utf-8">
  <title>Hireup - Webflow HTML Website Template</title>
  <meta content="Hireup is a responsive, high-converting, and beautifully designed job board for technology businesses. Bright, vibrant, and easily adapted, it offers the perfect starting point for numerous business types." name="description">
  <meta content="Hireup - Webflow HTML Website Template" property="og:title">
  <meta content="Hireup is a responsive, high-converting, and beautifully designed job board for technology businesses. Bright, vibrant, and easily adapted, it offers the perfect starting point for numerous business types." property="og:description">
  ...
  <meta content="Hireup - Webflow HTML Website Template" property="twitter:title">
  <meta content="Hireup is a responsive, high-converting, and beautifully designed job board for technology businesses. Bright, vibrant, and easily adapted, it offers the perfect starting point for numerous business types." property="twitter:description">
  ...
  <link href="css/talentmatchcapstone.webflow.css" rel="stylesheet" type="text/css">
  <link href="https://fonts.googleapis.com" rel="preconnect">
  <link href="https://fonts.gstatic.com" rel="preconnect" crossorigin="anonymous">
  <script src="https://ajax.googleapis.com/ajax/libs/webfont/1.6.26/webfont.js" type="text/javascript"></script>
  <script type="text/javascript">WebFont.load({  google: {    families: ["Archivo:100,200,300,regular,500,600,700,800,900","Inter:200,300,regular,500,600,700,800"]  }});</script>
...
<body>
  <div data-collapse="medium" data-animation="default" data-duration="400" data-easing="ease" data-easing2="ease" role="banner" class="navbar w-nav">
    <div class="container-navigation">
      <div class="navigation-left">
        <a href="index.html" aria-current="page" class="brand w-nav-brand w--current"><img src="images/Logo.png" loading="lazy" width="202" alt="" class="logo"></a>
      </div>
      <div class="navigation-middle">
        <nav role="navigation" class="nav-menu w-nav-menu">
          <a href="index.html" aria-current="page" class="nav-link w-nav-link w--current">Home</a>
          <a href="index.html" aria-current="page" class="nav-link w-nav-link w--current">Jobs</a>
          <a href="index.html" aria-current="page" class="nav-link w-nav-link w--current">Profile</a>
      ...
      <div class="navigation-right">
        <div class="navigation-button-wrap"><button class="button-primary" data-wf-user-logout="Log out" data-wf-user-login="Log in" type="button">Log out</button></div>
  ...
  <div class="section-header">
    <div class="container-regular">
      <div class="section-regular">
        <div data-w-id="441fd9a4-d2af-9334-a857-2b0b50b183c8" class="container-regular">
          <div class="cta-block">
            <div class="cta-icon-wrapper"><img src="images/Magnifying-Glass-Icon_1Magnifying-Glass-Icon.png" loading="lazy" alt="" class="icon-large"></div>
            <div class="cta-text-wrap">
              <div class="margin-bottom-16">
                <h4>Explore a job now! </h4>
              </div>
              <p class="paragraph-regular">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris rhoncus pharetra cursus. Suspendisse sodales porta leo, ac placerat ex pretium quis.</p>
            </div>
          </div>
          <div class="cta-search-wrapper">
            <form action="/search" class="search w-form">
              <div class="search-input-wrapper"><img src="images/Search-Icon.svg" loading="lazy" alt="" class="icon-regular"><input class="search-field w-input" maxlength="256" name="query" placeholder="Search…" type="search" id="search" required=""></div><input type="submit" class="search-button w-button" value="Search">
            </form>
          </div>
        </div>
      </div>
      <div class="banner-announcement">
        <div class="banner-container">
          <div class="banner-text-wrapper">
            <div class="paragraph-small">Discover over 1,000+ premium webflow components today!</div>
            <a href="http://www.flowbase.co" class="banner-button w-button">Unlock More</a>
          </div>
          <a href="#" class="banner-button-small w-inline-block">
  ...
  <div class="section-regular neutral-100">
    <div class="container-regular">
      <div data-w-id="37957543-e9bd-2ee5-9d77-68c8ee874409" style="-webkit-transform:translate3d(0, 44px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 44px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 44px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 44px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);opacity:0" class="title-wrap-row">
        <div class="title-wrap-left">
          <div class="margin-bottom-16">
            <h3>Explore the latest job openings</h3>
          </div>
          <p class="paragraph-regular text-gray-600">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed a mi rhoncus, pharetra leo et, efficitur tortor. Fusce vel convallis magna.</p>
        </div>
        <a href="browse.html" class="button-primary w-button">See All Jobs</a>
      </div>
      <div class="w-dyn-list">
        <div data-w-id="37957543-e9bd-2ee5-9d77-68c8ee874413" style="opacity:0;-webkit-transform:translate3d(0, 0, 0) scale3d(0.9, 0.9, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 0, 0) scale3d(0.9, 0.9, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 0, 0) scale3d(0.9, 0.9, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 0, 0) scale3d(0.9, 0.9, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)" role="list" class="collection-list-jobs w-dyn-items">
          <div role="listitem" class="w-dyn-item">
            <a href="#" class="job-border w-inline-block">
              <div class="job-company-wrap">
                <div class="icon-wrap-regular"><img src="" loading="lazy" alt="" class="icon-large w-dyn-bind-empty"></div>
                <div>
                  <div class="subheading-regular w-dyn-bind-empty"></div>
                  <div class="paragraph-small text-color-gray-500 w-dyn-bind-empty"></div>
                </div>
              </div>
              ...
              <div class="job-tags">
                <div class="job-category w-dyn-bind-empty"></div>
                <div class="job-hours w-dyn-bind-empty"></div>
              </div>
              <div class="job-card-details-wrap">
                <div class="job-details-wrap"><img src="https://uploads-ssl.webflow.com/63337525695d8ba70ab44222/63337525695d8b2585b442b4_Location%20Icon.svg" loading="lazy" alt="" class="icon-regular">
                  <div class="w-dyn-bind-empty"></div>
                </div>
                <div class="job-details-wrap"><img src="https://uploads-ssl.webflow.com/63337525695d8ba70ab44222/63337525695d8b73d8b44295_Salary%20Icon.svg" loading="lazy" alt="" class="icon-regular">
                  <div>$</div>
                  <div class="w-dyn-bind-empty"></div>
                </div>
              </div>
  ...
  <div class="section-regular neutral-100">
    <div class="container-small">
      <div data-w-id="fc77235b-851d-8cb8-7767-8e3c91b7d33a" style="-webkit-transform:translate3d(0, 44px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 44px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 44px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 44px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);opacity:0" class="title-wrap-center">
        <div class="margin-bottom-12">
          <div class="detail text-color-primary">TESTIMONIAL</div>
        </div>
        <h3>See what users say about our job platform</h3>
      </div>
      <div data-delay="4000" data-animation="cross" class="testimonial-slider w-slider" data-autoplay="false" data-easing="ease" style="-webkit-transform:translate3d(0, 44px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 44px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 44px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 44px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);opacity:0" data-hide-arrows="false" data-disable-swipe="false" data-w-id="fc77235b-851d-8cb8-7767-8e3c91b7d340" data-autoplay-limit="0" data-nav-spacing="3" data-duration="500" data-infinite="true">
        <div class="w-slider-mask">
          <div class="w-slide">
            <div class="w-layout-grid testimonial-grid">
              <div class="testimonial-content-wrap">
                <div class="testimonial-logo-wrap"><img src="https://uploads-ssl.webflow.com/63337525695d8ba70ab44222/63337525695d8b3fa3b4427d_Mail%20Chimp%20Icon.svg" loading="lazy" alt="" class="icon-extra-large"></div>
                <p class="testimonial-quote">“Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed a mi rhoncus, pharetra leo et, efficitur tortor. Fusce vel convallis magna”</p>
                <div class="paragraph-regular text-color-gray-600"><span class="text-color-primary">David Sinclair</span> - Senior Frontend Developer</div>
              </div>
              <div class="testimonial-image-wrap"><img src="https://uploads-ssl.webflow.com/63337525695d8ba70ab44222/634517c289833b2b6e36b6f2_Testimonial%20Image.jpg" loading="lazy" alt="" class="image-cover"></div>
            </div>
          </div>
          <div class="w-slide">
            <div class="w-layout-grid testimonial-grid">
              <div class="testimonial-content-wrap">
                <div class="testimonial-logo-wrap"><img src="https://uploads-ssl.webflow.com/63337525695d8ba70ab44222/63337525695d8b3fa3b4427d_Mail%20Chimp%20Icon.svg" loading="lazy" alt="" class="icon-extra-large"></div>
                <p class="testimonial-quote">“There are lot of interesting projects that casting directors post on this platform. So many people and companies trust casting through Platform”</p>
                <div class="paragraph-regular text-color-gray-600"><span class="text-color-primary">Emily York</span> - Senior Frontend Developer</div>
              </div>
              <div class="testimonial-image-wrap"><img src="https://uploads-ssl.webflow.com/63337525695d8ba70ab44222/63337525695d8b405fb44260_Why%20Choose%20Us%20Image%20(2).jpg" loading="lazy" alt="" class="image-cover"></div>
            </div>
          </div>
        </div>
        <div class="testimonial-slider-left-button w-slider-arrow-left">
          <div class="icon-regular w-embed"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none">
              <g clip-path="url(#clip0_416_918)">
                <path d="M7.828 11.0002L13.192 5.63617L11.778 4.22217L4 12.0002L11.778 19.7782L13.192 18.3642L7.828 13.0002H20V11.0002H7.828Z" fill="currentColor"></path>
              </g>
              <defs>
        ...
        <div class="testimonial-slider-right-button w-slider-arrow-right">
          <div class="icon-regular w-embed"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none">
              <g clip-path="url(#clip0_416_922)">
                <path d="M16.172 11.0002L10.808 5.63617L12.222 4.22217L20 12.0002L12.222 19.7782L10.808 18.3642L16.172 13.0002H4V11.0002H16.172Z" fill="currentColor"></path>
              </g>
              <defs>
        ...
        <div class="slide-nav-hidden w-slider-nav w-round"></div>
      </div>
    </div>
  </div>
  <div class="blog-section">
    <div class="container-regular">
      <div data-w-id="4c5fd0bb-be77-ca1b-0ecf-d0fd126a155f" class="blog-title-wrap">
        <div class="margin-bottom-12">
          <div class="detail text-color-primary">Blog</div>
        </div>
        <h3>Get the latest news about jobs!</h3>
      </div>
      <div data-delay="4000" data-animation="slide" class="blog-slider w-slider" data-autoplay="false" data-easing="ease" data-hide-arrows="false" data-disable-swipe="false" data-w-id="4c5fd0bb-be77-ca1b-0ecf-d0fd126a1565" data-autoplay-limit="0" data-nav-spacing="3" data-duration="500" data-infinite="true">
        <div class="blog-mask w-slider-mask">
          <div class="blog-slide w-slide">
            <div class="collection-list-wrapper w-dyn-list">
              <div role="list" class="regular-collection-list w-dyn-items">
                <div role="listitem" class="w-dyn-item">
                  <div class="blog-card">
                    <div class="blog-card-thumbnail"><img src="" loading="lazy" alt="" class="image-cover w-dyn-bind-empty"></div>
                    <div class="blog-text-wrapper">
                      <div class="blog-category w-dyn-bind-empty"></div>
                      <h5 class="blog-title w-dyn-bind-empty"></h5>
                      <div class="blog-created-wrapper">
                        <div class="blog-dot"></div>
                        <div class="blog-card-created w-dyn-bind-empty"></div>
                      </div>
                      <a href="#" class="button-secondary-right-icon w-inline-block">
                        <div>Read More</div>
                        <div class="icon-regular w-embed"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none">
                            <path d="M15.187 11.2362L11.0895 7.13873L12.1696 6.05859L18.1111 12.0001L12.1696 17.9416L11.0895 16.8615L15.187 12.764H5.88892V11.2362H15.187Z" fill="currentColor"></path>
                          </svg></div>
                      </a>
                    </div>
                  </div>
        ...
        <div class="blog-slider-left-button w-slider-arrow-left">
          <div class="icon-regular w-embed"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none">
              <g clip-path="url(#clip0_416_918)">
                <path d="M7.828 11.0002L13.192 5.63617L11.778 4.22217L4 12.0002L11.778 19.7782L13.192 18.3642L7.828 13.0002H20V11.0002H7.828Z" fill="currentColor"></path>
              </g>
        ...
        <div class="blog-slider-right-button w-slider-arrow-right">
          <div class="icon-regular w-embed"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none">
              <g clip-path="url(#clip0_416_922)">
                <path d="M16.172 11.0002L10.808 5.63617L12.222 4.22217L20 12.0002L12.222 19.7782L10.808 18.3642L16.172 13.0002H4V11.0002H16.172Z" fill="currentColor"></path>
              </g>
  ...
  <div class="footer-section">
    <div data-w-id="27694c21-cbfc-58f0-1e5c-e47458f6d8b6" class="container-regular">
      <a href="#" class="footer-logo-link w-inline-block"><img src="images/Logo.png" loading="lazy" alt="Brand" class="footer-logo"></a>
      <div class="footer-grid">
        <div class="w-layout-grid footer-left-column">
          <div class="footer-column">
            <div class="margin-bottom-16">
              <div class="detail text-color-gray-400">pages</div>
            </div>
            <a href="index.html" aria-current="page" class="footer-link w--current">Home</a>
            <a href="home-alternative.html" class="footer-link">Home V2</a>
            <a href="about.html" class="footer-link">About</a>
            <a href="pricing.html" class="footer-link">Pricing</a>
            <a href="browse.html" class="footer-link">Jobs</a>
            <a href="post-job.html" class="footer-link">Post a Job</a>
          </div>
          <div class="footer-column">
            <div class="margin-bottom-16">
              <div class="detail text-color-gray-400">account</div>
            </div>
          ...
          <div class="footer-column">
            <div class="margin-bottom-16">
              <div class="detail text-color-gray-400">template</div>
            </div>
            <a href="template/style-guide.html" class="footer-link">Style Guide</a>
            <a href="template/license.html" class="footer-link">License</a>
        ...
        <div id="w-node-_27694c21-cbfc-58f0-1e5c-e47458f6d8dd-cf9aae39" class="foooter-right-column">
          <div class="footer-form-wrapper">
            <div class="margin-bottom-16">
              <div class="detail text-color-gray-400">Sign up to our newsletter</div>
            </div>
            <div class="footer-form-block w-form">
              <form id="email-form" name="email-form" data-name="Email Form" method="get" class="footer-form" data-wf-page-id="6650f385db1f6f7c9f5dd967" data-wf-element-id="27694c21-cbfc-58f0-1e5c-e47458f6d8e3"><input class="form-text-field w-input" maxlength="256" name="email-2" data-name="Email 2" placeholder="Email address" type="email" id="footer-email" required=""><input type="submit" data-wait="Get Started" class="button-primary w-button" value="Get Started"></form>
          ...
          <div class="footer-legal-text-wrapper"></div>
        </div>
      </div>
  ...
  <script src="https://d3e54v103j8qbb.cloudfront.net/js/jquery-3.5.1.min.dc5e7f18c8.js?site=6650f384db1f6f7c9f5dd916" type="text/javascript" integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0=" crossorigin="anonymous"></script>
